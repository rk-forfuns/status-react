...
(def ui
  {:empty-chats-header (js/require "./resources/images/ui/empty-chats-header.png")
   ...
   :ETH-asset          (js/require "./resources/images/tokens/mainnet/0-native.png")
   :SNT-asset          (js/require "./resources/images/tokens/mainnet/SNT.png")
   :tozemoon-asset     (js/require "./resources/images/ui/celebrate-tozemoon.png")
