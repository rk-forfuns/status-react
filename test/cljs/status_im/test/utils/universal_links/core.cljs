      ...
      (let [db {:multiaccount      {:public-key "pk"}
        ...
        (testing "a user profile link"
          (testing "it loads the profile, short version"
            (let [actual (links/handle-url {:db db} "status-im://0x04fbce10971e1cd7253b98c7b7e54de3729ca57ce41a2bfb0d1c4e0a26f72c4b6913c3487fa1b4bb86125770f1743fb4459da05c1cbe31d938814cfaf36e252073")]
        ...
        (testing "Handle a custom string as a an profile link with ens-name"
          (is (= (get-in (links/handle-url {:db db} "status-im://@CONTACTCODE")
